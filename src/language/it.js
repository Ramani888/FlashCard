export default {
  ...
  subscriptionNote:
    "L'abbonamento è addebitato mensilmente. I crediti vengono ripristinati mensilmente. Tutte le informazioni sono salvate nel cloud mensilmente.",
  tier1: 'LIVELLO 1',
  aiCredit: 'CREDITI',
  ...
  submit: 'INVIA',
  aiLimitMessage:
    'Hai raggiunto il limite di crediti! Guarda un annuncio video per guadagnare più crediti.',
  ...
  noteLabel: 'Nota: ',
  spamFolderNote: "Controlla la cartella spam se non hai ricevuto l'email.",

  contactNotfound: 'Contatto non trovato',
  watchAd: "Guarda l'annuncio",
  earnCredits: 'Guadagna 2 crediti',
