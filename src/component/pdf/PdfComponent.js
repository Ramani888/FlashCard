    ...
    return (
        <View style={styles.container}>
            ...
            <CustomeModal
                ...
                modalContainerStyle={[
                    styles.modal,
                    { top: modalPosition.y, left: modalPosition.x, backgroundColor: colorTheme.modelBackgroundView },
                ]}
            />
        </View>
    );
...
const styles = StyleSheet.create({
    ...
    indicatorStyle: { marginTop: verticalScale(12), backgroundColor: Color.mediumGray },
    sheetContainer: {
        flexDirection: 'row',
        gap: scale(50),
