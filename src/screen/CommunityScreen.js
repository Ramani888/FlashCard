...
const GlobalLiveFeedScreen = () => {
    ...
    console.log('liveFeedData', liveFeedData)
        ...
        ({ item }) => (
            <View>
                <View
                    ...
                    <Pressable onPress={() => navigation.navigate(ScreenName.otherUserCard, { item: item })}>
                        <Image
...
//     const handlePlusButtonLayout = (event) => {
...
//                     style={[
//                         styles.itemContainer,
//                         { backgroundColor: theme.listAndBoxColor },
//                     ]}
//                 >
//                     <Pressable
//                         onPress={() =>
...
//                 >
//                     <View
//                         style={[styles.cardHeader, { backgroundColor: theme.cardHeader1 }]}
//                     >
//                         <Text style={[styles.cardTitle, { color: theme.textColor }]}>
//                             {item.top}
//                         </Text>
//                         <View
//                             onLayout={handlePlusButtonLayout}
//                             style={styles.plusIconView}
//                         >
//                             <Entypo
//                                 name="plus"
...
//                     </View>
//                     <View
//                         style={[styles.cardBody, { backgroundColor: theme.listAndBoxColor }]}
//                     >
//                         <Text style={[styles.cardDesc, { color: theme.textColor }]}>
//                             {item?.bottom}
//                         </Text>
//                     </View>
//                 </Pressable>
...
//     return (
//         <View style={[styles.screenContainer, { backgroundColor: theme.background1 }]}>
...
//                     >
//                         <Entypo name="plus" size={scale(20)} color={Color.Black} />
//                         <Text style={[styles.modalContentText,{color:}]}>{strings.addCard}</Text>
//                     </Pressable>
//                 }
//                 width={'31%'}
//                 justifyContent="flex-end"
