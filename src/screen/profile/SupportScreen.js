...
const issueData = [
    ...
    { issueName: strings.feedback },
    { issueName: strings.issues },
    { issueName: strings.suggestions },
];
...
const SupportScreen = () => {
            ...
            return (
                <View>
                    ...
                    {selectedIssueIndex === index && (
                        <CustomeInputField
                            placeholder={`${strings.enter} ${selectedIssue}...`}
    ...
    const renderBody = useCallback(
        ...
        [handleSelectFromGallery, renderIssue, imageFile, strings],
    );
